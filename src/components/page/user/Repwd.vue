        ...
        <div class="login">
            <div class="login-top">
                ...
                <form @submit.prevent="checkform" ref="register">
                    ...
                    <div class="forgot">
                        <el-button type="primary" @click="submitForm()" size="large" style="background-color: #666666;width: 60%;">
                            修改新密码
                        </el-button>
                    </div>
                </form>
            ...
            <div class="login-bottom">
                <h4><a style="color: #666666" href="/">返回首页<span> | </span></a>
                    <a style="color: #666666" href="/#/userlogin">立即登录</a></h4>
            </div>
        </div>
    </div>
</template>
        ...
        methods: {
            ...
            checkform() {
                ...
                if (this.checkform() != false) {
                    this.$axios.post('/api/userInfo/repwd', this.param).then(res => {
                        if (res.data.code == 200) {
                            this.$message.success(res.data.msg);
