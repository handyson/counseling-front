<template>
    <div style="height: 100%">
        ...
        <div style="width: 90%; margin-left: 10%; margin-top: 50px">
            ...
            <div
                style="width: 23%; float: left; margin-left: 20px; margin-bottom: 10px"
            ...
            >
                ...
                <el-card class="box-card">
                    <div slot="header" class="clearfix">
                        ...
                        <!--              设置默认按钮-->
                        <el-button style="float: right; padding: 3px 0" type="text" v-show="item.isFirst == 1 ? false : true">
                            设置为默认
                        </el-button>
                        <!--              删除按钮-->
                        <el-button style="float: right; padding: 3px 0" type="text" v-show="item.isFirst == 1 ? false : true">
            ...
            <button class="addbtn2" @click="addVis = !addVis">添加</button>
            <!--      <div class="addbtn"-->
        ...
        <el-dialog title="添加地址" :visible.sync="addVis" width="30%">
            <el-form ref="form" :model="form" :rules="rules" label-width="95px">
                <el-form-item label="收件人" prop="reseP">
                    <el-input v-model="form.reseP"></el-input>
                </el-form-item>
                ...
                <el-form-item label="地址" prop="address">
                    <div class="block">
                        ...
                        <el-cascader placeholder="地址" v-model="form.address" :options="options" filterable></el-cascader>
                    </div>
                </el-form-item>
