            ...
            <div class="loginContainer">
                <el-form ref="loginForm" :rules="rules" :model="loginForm" label-width="80px">
                    ...
                    <div>
                        ...
                        <el-button type="primary" style="width: 45%" @click="submitLogin" v-loading.fullscreen.lock="fullscreenLoading"
                            >登录</el-button
                        >
                    </div>
                </el-form>
                ...
                if (valid) {
                    ...
                    this.postKeyValueRequest('/doLogin', this.loginForm).then((resp) => {
                        ...
                        if (resp) {
                            ...
                            // localStorage.setItem('user', resp.obj);
                            localStorage.setItem('user_name', resp.obj.username);
                            localStorage.setItem('user_icon', resp.obj.avatar);
                            // localStorage.setItem('user_id', resp.obj.id);
