    ...
    <div>
        ...
        <el-row :gutter="20" style="margin-top: -20px;">
            ...
            <el-col :span="12" style="width: 49%;">
                <el-card shadow="hover" id="commentbox"
        ...
        methods: {
            ...
            getcommentcount() {
                this.$axios.get('/api/adminhome/adminHomeViewCommentLimit?offset=0&limit=' + this.count).then(res => {
                    if (this.commentcount.length >= res.data.length)
                        this.countfinal = true;
                ...
                for (let i = 0; i < length; i++) {
                    ...
                    this.commentcount[i].createtimeString = createtime.getFullYear() + "-" + month + "-" + createtime.getDate() + " " + createtime.getHours() + ":" + createtime.getMinutes();
                }
            },
            getbingtu() {
