    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item> <i class="el-icon-lx-cascades"></i> 咨询师资质管理 </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
    ...
    methods: {
        ...
        delAllSelection() {
            ...
            for (let i = 0; i < length; i++) {
                axios
                    .get('/api/consltCertification/deleteByFlag?id=' + this.multipleSelection[i].c_user_id)
                    .then((res) => {})
                    .catch((error) => {
                        console.log('接口请求异常');
                    });
        ...
        getData() {
            ...
            axios
                .post('/api/consltCertification/selectKeyByLimit', this.query)
                .then((res) => {
                    console.log(res);
        ...
        // 保存编辑
        saveEdit() {
            axios.post('/api/consltCertification/edit', this.form).then((res) => {
