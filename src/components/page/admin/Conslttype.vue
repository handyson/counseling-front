        ...
        methods: {
            ...
            changeData() {
                ...
                for (let i = 0; i < len; i++) {
                    ...
                    this.read[i].createtimeString = createtime.getFullYear() + "-" + month + "-" + createtime.getDate() + " " + createtime.getHours() + ":" + createtime.getMinutes();
                    var logintime = new Date(this.read[i].logintime);
                    month = logintime.getMonth() + 1;
                    this.read[i].logintimeString = logintime.getFullYear() + "-" + month + "-" + logintime.getDate() + " " + logintime.getHours() + ":" + logintime.getMinutes();
                }
            },
