    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 咨询师信息
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
    ...
    export default {
        ...
        methods: {
            deletegoods(index, row) {
                axios.get('/api/goods/deleteByFlag?id=' + row.c_user_id).then(res => {
                ...
                for (let i = 0; i < length; i++) {
                    axios.get('/api/goods/deleteByFlag?id=' + this.multipleSelection[i].c_user_id).then(res => {
                    }).catch(error => {
                        console.log("接口请求异常");
                    });
                }
                ...
                axios.post('/api/goods/selectKeyByLimit', this.query).then(res => {
                    console.log(res);
