    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column label="咨询师ID" prop="goodsid" align="center"></el-table-column>
                <el-table-column label="图片" align="center">
                    <template slot-scope="scope">
                        <el-image class="table-td-thumb" :src="scope.row.ssrc" :preview-src-list="[scope.row.ssrc]"></el-image>
                    </template>
                </el-table-column>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="form" :model="form" label-width="90px">
                <el-form-item label="关联咨询师">
                    <el-select v-model="form.goodsid" placeholder="请选择关联咨询师">
                        <el-option v-for="item in consultantList" :key="item.goodsid" :label="item.goodsname" :value="item.goodsid">
                        </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="图片">
                    ...
                    >
                        <img v-if="form.ssrc" :src="form.ssrc" class="avatar" style="height: 180px" />
        ...
        <el-dialog title="添加" :visible.sync="addVisible" width="30%">
            <el-form ref="aform" :model="aform" label-width="90px">
                <el-form-item label="关联咨询师">
                    <el-select v-model="aform.goodsid" placeholder="请选择关联咨询师">
                        <el-option v-for="item in consultantList" :key="item.goodsid" :label="item.goodsname" :value="item.goodsid">
                        </el-option>
                    </el-select>
                </el-form-item>
                ...
                <el-form-item label="图片">
                    <el-upload
                        ...
                        :before-upload="beforeAvatarUpload"
                    >
                        <img v-if="aform.ssrc" :src="aform.ssrc" class="avatar" style="height: 180px" />
                        <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                    </el-upload>
                </el-form-item>
            </el-form>
...
export default {
    ...
    methods: {
        deleterow(index, row) {
            axios
                .get('/api/scrolltofigure/deleteById?id=' + row.scrolltofigureid)
                .then((res) => {
        ...
        delAllSelection() {
            ...
            for (let i = 0; i < length; i++) {
                axios
                    .get('/api/scrolltofigure/deleteById?id=' + this.multipleSelection[i].scrolltofigureid)
                    .then((res) => {})
                    .catch((error) => {
                        console.log('接口请求异常');
                    });
        ...
        getData() {
            ...
            axios
                .post('/api/scrolltofigure/selectKeyByLimit', this.query)
                .then((res) => {
